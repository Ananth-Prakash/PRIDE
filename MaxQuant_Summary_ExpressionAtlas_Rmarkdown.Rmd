...
Figure 5.  Correlation between samples. The pairwise Pearson correlation was calculated between normalised intensities (iBAQs) of each sample and herirarchically clustered.  
